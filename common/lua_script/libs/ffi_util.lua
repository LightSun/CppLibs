...
local defineprocessor = "cpp -dM" -- "cl /md"
local definestr = ""
...
-- skipcdef/skipdefines/defines:  can be nil
-- func_file: often used to out all funcs
-- def_file: often used to out all defs

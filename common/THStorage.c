...
#include "internal/THStorage.c"
#include "THGenerateAllTypes.h"

#include "internal/THStorage.c"
#include "THGenerateHalfType.h"

#include "internal/THStorageCopy.c"
#include "THGenerateAllTypes.h"
...
int THLongStorage_inferSize2(THLongStorage *output, long *sizesA, long dimsA, long *sizesB, long dimsB,
  ...
  long *expandedSizes = (long *)THAlloc(sizeof(long)*ndim);
...
int THLongStorage_inferExpandGeometry(long *tensorSizes, long *tensorStrides, long tensorDim,
  ...
  long *expandedSizesCalc = (long *)THAlloc(sizeof(long)*ndim);
  long *expandedStridesCalc = (long *)THAlloc(sizeof(long)*ndim);

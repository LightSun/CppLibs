...
#ifndef MED_ASSERT_FMT
#define MED_ASSERT_FMT(condition, fmt, ...)                                 \
    do                                                                      \
    {                                                                       \
        if (!(condition))                                                   \
        {                                                                   \
...
#ifndef MED_ASSERT_FMT_N
#define MED_ASSERT_FMT_N(condition, n, fmt, ...)                                 \
    do                                                                      \
    {                                                                       \
        if (!(condition))                                                   \
        {                                                                   \
...
#define PRINT(fmt, ...) \
 do{ \
    char _buf[128];\
    snprintf(_buf, 128, fmt, ##__VA_ARGS__);\
    std::cout << _buf; \
}while(0);
